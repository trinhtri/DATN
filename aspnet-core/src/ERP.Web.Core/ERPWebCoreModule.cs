...
using ERP.Startup;
using ERP.Web.Authentication.JwtBearer;
using ERP.Web.Authentication.TwoFactor;
...
namespace ERP.Web
{
    ...
    public class ERPWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ERPWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ERPWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(ERPWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
