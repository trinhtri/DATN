...
export class CommentServiceProxy {
     ...
     * @return Success
     */
    create(input: CreateCommentDto | null | undefined): Observable<number> {
     ...
     * @return Success
     */
    getAll(issue_Id: number | null | undefined): Observable<CommentListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Comment/GetAll?";
        if (issue_Id !== undefined)
            url_ += "Issue_Id=" + encodeURIComponent("" + issue_Id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAll(response: HttpResponseBase): Observable<CommentListDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(CommentListDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
     ...
     * @return Success
     */
    getId(id: number | null | undefined): Observable<CreateCommentDto> {
        let url_ = this.baseUrl + "/api/services/app/Comment/GetId?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CreateCommentDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateCommentDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetId(response: HttpResponseBase): Observable<CreateCommentDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CreateCommentDto.fromJS(resultData200) : new CreateCommentDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CreateCommentDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(input: CreateCommentDto | null | undefined): Observable<void> {
...
export class DocumentServiceProxy {
     ...
     * @return Success
     */
    create(input: CreateDocumentDto | null | undefined): Observable<number> {
     ...
     * @return Success
     */
    getId(id: number | null | undefined): Observable<CreateDocumentDto> {
        let url_ = this.baseUrl + "/api/services/app/Document/GetId?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CreateDocumentDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateDocumentDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetId(response: HttpResponseBase): Observable<CreateDocumentDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CreateDocumentDto.fromJS(resultData200) : new CreateDocumentDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CreateDocumentDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(input: CreateDocumentDto | null | undefined): Observable<void> {
     ...
     * @return Success
     */
    getDocumentToExcel(project_Id: number | null | undefined, filter: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Document/GetDocumentToExcel?";
        if (project_Id !== undefined)
            url_ += "Project_Id=" + encodeURIComponent("" + project_Id) + "&"; 
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDocumentToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDocumentToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetDocumentToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class DocumentListExcelExporterServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    exportToFile(list: DocumentListDto[] | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/DocumentListExcelExporter/ExportToFile";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class IssueServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(input: CreateIssueDto | null | undefined): Observable<number> {
     ...
     * @return Success
     */
    getId(id: number | null | undefined): Observable<CreateIssueDto> {
        let url_ = this.baseUrl + "/api/services/app/Issue/GetId?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CreateIssueDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateIssueDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetId(response: HttpResponseBase): Observable<CreateIssueDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CreateIssueDto.fromJS(resultData200) : new CreateIssueDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CreateIssueDto>(<any>null);
    }
     ...
     * @return Success
     */
    getIssueForDetail(id: number | null | undefined): Observable<CommonListDto> {
        let url_ = this.baseUrl + "/api/services/app/Issue/GetIssueForDetail?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetIssueForDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetIssueForDetail(<any>response_);
                } catch (e) {
    ...
    protected processGetIssueForDetail(response: HttpResponseBase): Observable<CommonListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(input: CreateIssueDto | null | undefined): Observable<void> {
     ...
     * @return Success
     */
    startProgress(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Issue/StartProgress?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processStartProgress(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processStartProgress(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processStartProgress(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    stopProgress(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Issue/StopProgress?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processStopProgress(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processStopProgress(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processStopProgress(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    resolved(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Issue/Resolved?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processResolved(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processResolved(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processResolved(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    closeProgress(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Issue/CloseProgress?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCloseProgress(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCloseProgress(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCloseProgress(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    reOpenProgress(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Issue/ReOpenProgress?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processReOpenProgress(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processReOpenProgress(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processReOpenProgress(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class MemberServiceProxy {
     ...
     * @return Success
     */
    create(input: CreateMemberDto | null | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Member/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getId(id: number | null | undefined): Observable<CreateMemberDto> {
        let url_ = this.baseUrl + "/api/services/app/Member/GetId?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CreateMemberDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateMemberDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetId(response: HttpResponseBase): Observable<CreateMemberDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CreateMemberDto.fromJS(resultData200) : new CreateMemberDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CreateMemberDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(project_Id: number | null | undefined, filter: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfMemberListDto> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfMemberListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(input: CreateMemberDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Member/Update";
        url_ = url_.replace(/[?&]$/, "");
...
export class ProjectServiceProxy {
     ...
     * @return Success
     */
    create(input: CreateProjectDto | null | undefined): Observable<number> {
     ...
     * @return Success
     */
    getId(id: number | null | undefined): Observable<CreateProjectDto> {
        let url_ = this.baseUrl + "/api/services/app/Project/GetId?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CreateProjectDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateProjectDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetId(response: HttpResponseBase): Observable<CreateProjectDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CreateProjectDto.fromJS(resultData200) : new CreateProjectDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CreateProjectDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(filter: string | null | undefined, status: boolean | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfProjectListDto> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfProjectListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfProjectListDto.fromJS(resultData200) : new PagedResultDtoOfProjectListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    update(input: CreateProjectDto | null | undefined): Observable<void> {
     ...
     * @return Success
     */
    getProjectToExcel(filter: string | null | undefined, status: boolean | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Project/GetProjectToExcel?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (status !== undefined)
            url_ += "Status=" + encodeURIComponent("" + status) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetProjectToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetProjectToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetProjectToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    lockUser(input: EntityDtoOfInt64 | null | undefined): Observable<void> {
     ...
     * @return Success
     */
    getName(id: number | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/User/GetName?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
...
export class PagedResultDtoOfIssueListDto implements IPagedResultDtoOfIssueListDto {
    totalCount!: number | undefined;
    items!: IssueListDto[] | undefined;

    constructor(data?: IPagedResultDtoOfIssueListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(IssueListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfIssueListDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfIssueListDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfIssueListDto {
    totalCount: number | undefined;
    items: IssueListDto[] | undefined;
}
...
export class IssueListDto implements IIssueListDto {
    ...
    static fromJS(data: any): IssueListDto {
        data = typeof data === 'object' ? data : {};
        let result = new IssueListDto();
        result.init(data);
        return result;
    }
...
export class CommonListDto implements ICommonListDto {
    ...
    static fromJS(data: any): CommonListDto {
        data = typeof data === 'object' ? data : {};
        let result = new CommonListDto();
        result.init(data);
        return result;
    }
