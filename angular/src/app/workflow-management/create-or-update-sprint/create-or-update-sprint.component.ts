...
import { IssueServiceProxy, ProjectServiceProxy, CommonAppserviceServiceProxy, CreateIssueDto, ERPComboboxItem, SprintServiceProxy, SprintListDto } from '@shared/service-proxies/service-proxies';
...
export class CreateOrUpdateSprintComponent extends AppComponentBase implements OnInit {
  ...
  sprint: SprintListDto = new SprintListDto();
  dueDate = new Date();
  active = false;
  saving = false;
  lst: ERPComboboxItem [] = [];
